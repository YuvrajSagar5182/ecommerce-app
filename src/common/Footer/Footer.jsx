...
const Footer = () => {
  return (
    <footer className="text-white bg-[#3f83f8] body-font bottom-0">
      <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
        <Link className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
          <img
            ...
            alt="Logo"
          />
          <span className="ml-3 text-xl text-white">Yuvi's Ecommerce</span>
        </Link>
        <p className="text-sm text-white sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">
          © 2023 Yuvi's E-commerce —
          <Link
        ...
        <span className="inline-flex text-white sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
          <Link
          ...
          <Link
            to="https://www.linkedin.com/in/yuvraj-sagar-514806227/"
            className="ml-3 text-white">
            <svg
              fill="currentColor"
              stroke="currentColor"
